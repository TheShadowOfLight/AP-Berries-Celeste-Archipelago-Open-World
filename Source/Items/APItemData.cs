...
namespace Celeste.Mod.Celeste_Multiworld.Items
{
    ...
    internal class APItemData
    {
        ...
        public static Dictionary<long, CheckpointItemData> CheckpointData { get; set; } = new Dictionary<long, CheckpointItemData>
        {
            ...
            { 0xCA141B, new CheckpointItemData(6, 0, "00") },
            { 0xCA141C, new CheckpointItemData(6, 0, "04") },
            { 0xCA141D, new CheckpointItemData(6, 0, "b-00") },
            { 0xCA141E, new CheckpointItemData(6, 0, "boss-00") },
            { 0xCA141F, new CheckpointItemData(6, 0, "after-00") },

            { 0xCA1420, new CheckpointItemData(6, 1, "b-00") },
            { 0xCA1421, new CheckpointItemData(6, 1, "c-00") },
            { 0xCA1422, new CheckpointItemData(6, 1, "d-00") },

            { 0xCA1423, new CheckpointItemData(7, 0, "b-00") },
            { 0xCA1424, new CheckpointItemData(7, 0, "c-00") },
            { 0xCA1425, new CheckpointItemData(7, 0, "d-00") },
            { 0xCA1426, new CheckpointItemData(7, 0, "e-00b") },
            { 0xCA1427, new CheckpointItemData(7, 0, "f-00") },
            { 0xCA1428, new CheckpointItemData(7, 0, "g-00") },

            { 0xCA1429, new CheckpointItemData(7, 1, "b-00") },
            { 0xCA142A, new CheckpointItemData(7, 1, "c-01") },
            { 0xCA142B, new CheckpointItemData(7, 1, "d-00") },
            { 0xCA142C, new CheckpointItemData(7, 1, "e-00") },
            { 0xCA142D, new CheckpointItemData(7, 1, "f-00") },
            { 0xCA142E, new CheckpointItemData(7, 1, "g-00") },

            { 0xCA142F, new CheckpointItemData(9, 0, "a-00") },
            { 0xCA1430, new CheckpointItemData(9, 0, "c-00") },
            { 0xCA1431, new CheckpointItemData(9, 0, "d-00") },

            { 0xCA1432, new CheckpointItemData(9, 1, "a-00") },
            { 0xCA1433, new CheckpointItemData(9, 1, "b-00") },
            { 0xCA1434, new CheckpointItemData(9, 1, "c-01") },

            { 0xCA1435, new CheckpointItemData(10, 0, "a-00") },
            { 0xCA1436, new CheckpointItemData(10, 0, "c-00") },
            { 0xCA1437, new CheckpointItemData(10, 0, "e-00z") },
            { 0xCA1438, new CheckpointItemData(10, 0, "f-door") },
            { 0xCA1439, new CheckpointItemData(10, 0, "h-00b") },
            { 0xCA143A, new CheckpointItemData(10, 0, "i-00") },
            { 0xCA143B, new CheckpointItemData(10, 0, "j-00") },
            { 0xCA143C, new CheckpointItemData(10, 0, "j-16") },
        };
    }
}
